...
public class DataSourceFactory {
    ...
    static final String BASE_PACKAGES = "com.test.jta.mapper";
    ...
    public CustomSqlSessionTemplate sqlSessionTemplate(SqlSessionFactory sqlSessionFactoryOne, SqlSessionFactory sqlSessionFactoryTwo) {
        ...
        sqlSessionFactoryMap.put(DataSourceNames.DataSourceOne, sqlSessionFactoryOne);
        sqlSessionFactoryMap.put(DataSourceNames.DataSourceTwo, sqlSessionFactoryTwo);
